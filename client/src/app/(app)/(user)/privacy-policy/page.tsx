  ...
  return (
    <main className="pt-3 w-full px-5 lg:px-14 flex gap-3 flex-col pb-10 max-w-[95rem] items-center h-full min-h-[calc(100dvh_-_11dvh)]">
      ...
      <p className="text-lg max-w-[50rem] text-neutral-700 dark:text-neutral-300">
        ...
        Privacy Policy sets out how Alphasuits processes, uses
        ...
        <Link href={"/"} className="text-neutral-950 dark:text-white">www.alphasuits.com.np</Link>{" "}
        ...
        <span className="text-neutral-950 dark:text-white">Alphasuits</span> (the
        Site, products, services, and social media pages, collectively, the
        &quot;Services&quot;). Here you may find why and how Alphasuits
        collects that information, how it uses that information, and
        ...
        information to{" "}
        <span className="text-neutral-950 dark:text-white">Alphasuits</span>, you
