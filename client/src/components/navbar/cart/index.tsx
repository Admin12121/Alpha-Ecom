    ...
    <Sheet onOpenChange={handleOpenChange}>
      <SheetTrigger asChild>
        <Button variant="ghost" size="icon" className="h-8 w-8 px-0">
          ...
          {totalPieces > 0 && (
            <span className="absolute bg-purple-600 text-white w-[18px] h-[18px] text-[9px] top-0 flex items-center justify-center rounded-full right-0 border-[3px] !border-white dark:!border-transparent">
              {totalPieces}
            </span>
          )}
        </Button>
